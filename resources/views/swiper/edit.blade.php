            ...
            <div class="card col-12">
                <div class="col-12">
                    <div class="row justify-content-center  __web-inspector-hide-shortcut__">
                        <form action="{{route('swiper.swiper.update',$swiper)}}" method="post" class="col-sm-8" id="form-icon">
                            @csrf @method('PUT')
                            <div class="card-body">

                                <div class="col-sm-8">
                                    <div class="input-group mb-1">
                                        <input type="text" name="icon" value="{{$swiper->icon}}" class="form-control ">
                                        <div class="input-group-append">
                                            <button onclick="upImagePc(this)" class="btn btn-secondary" type="button">上传图片</button>
                                        </div>
                                    </div>
                                    <div style="display: inline-block;position: relative;">
                                        <img src="{{$swiper->icon}}" class="img-responsive img-thumbnail" width="500">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    <label>图片跳转连接</label>
                                    <input type="text" class="form-control " name="url" value="{{$swiper->url}}">
                                </div>
                            </div>
