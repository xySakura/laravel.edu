                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <a href="profile-posts.html" class="avatar">
                                        <img src="{{asset('org/Dashkit/assets')}}/img/avatars/profiles/avatar-5.jpg" alt="..." class="avatar-img rounded-circle">
                                    </a>
                        ...
                        <li class="list-group-item px-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <a href="profile-posts.html" class="avatar">
                                        <img src="{{asset('org/Dashkit/assets')}}/img/avatars/profiles/avatar-6.jpg" alt="..." class="avatar-img rounded-circle">
                                    </a>
                        ...
                        <li class="list-group-item px-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <a href="profile-posts.html" class="avatar">
                                        <img src="{{asset('org/Dashkit/assets')}}/img/avatars/profiles/avatar-7.jpg" alt="..." class="avatar-img rounded-circle">
                                    </a>
                        ...
                        <li class="list-group-item px-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <a href="profile-posts.html" class="avatar">
                                        <img src="{{asset('org/Dashkit/assets')}}/img/avatars/profiles/avatar-8.jpg" alt="..." class="avatar-img rounded-circle">
                                    </a>
                    ...
                    <a class="list-group-item px-0" href="#!">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img src="{{asset('org/Dashkit/assets')}}/img/avatars/profiles/avatar-3.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                    ...
                    <a class="list-group-item px-0" href="#!">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <!-- Avatar -->
                                <div class="avatar avatar-sm">
                                    <img src="{{asset('org/Dashkit/assets')}}/img/avatars/profiles/avatar-4.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="index.html">
            <img src="{{asset('org/Dashkit/assets')}}/img/logo.svg" class="navbar-brand-img 
          mx-auto" alt="...">
        </a>
            ...
            <div class="dropdown">
                ...
                <a href="#!" id="sidebarIcon" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-sm avatar-online">
                        <img src="{{asset('org/Dashkit/assets')}}/img/avatars/profiles/avatar-1.jpg" class="avatar-img rounded-circle" alt="...">
                    </div>
                </a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                <!-- Avatar -->
                                <a href="project-overview.html" class="avatar avatar-4by3">
                                    <img src="{{asset('org/Dashkit/assets')}}/img/avatars/projects/project-5.jpg" alt="..." class="avatar-img rounded">
                                </a>
